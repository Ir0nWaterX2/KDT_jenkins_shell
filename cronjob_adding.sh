...
grep -v "* * * * * /home/ubuntu/shell/resource_loging.sh" /home/ubuntu/crontab/current_crontab.txt | grep -v "* * * * * sudo logrotate -f /etc/logrotate.d/resourcelog" > /home/ubuntu/crontab/new_crontab.txt
